...
class NERPredictor:
    ...
    def __init__(self, model_archived_file:str, cuda_device: str = "cuda:1"):
...
if __name__ == '__main__':
    ...
    parser.add_argument("-paperDir",dest='paper_dir',action='store',help="directory that contains files to be predicted")
    ...
    for subdir, dirs, files in os.walk(paper_dir):
        for file in tqdm(files, desc="Files"):
            ...
            # if paper != '../pdfs/test/04-09-2019-paper-22.pdf.txt':
            #     continue
            print(paper)
            with open(paper) as f:
                ...
                for line in f:
                    ...
                    if line=='':
                        if sentence.strip()!='':
                            ...
                            # labels.append(label)
                            sentences.append(' '.join(sentence.strip().split()[0:]))
                ...
                for i,words in enumerate(sentences):
                    ...
                    for j,word in enumerate(words):
                        ...
                        fout.write(word+' '+prediction[i][j]+'\n')
                    fout.write('\n')
